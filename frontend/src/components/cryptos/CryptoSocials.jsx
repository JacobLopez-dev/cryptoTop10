...
function CryptoSocials({urls}) {
  ...
  return (
    <div className="grid lg:grid-cols-2 lg:grid-rows-2 md:grid-cols-2 md:col-span-2 lg:col-span-1 col-span-1 gap-3 justify-items-center">
      ...
      <div className="card w-60 h-40 bg-neutral text-neutral-content border-2">
        <div className="card-body items-center text-center">          
          <button onClick={()=>handleClick(urls.twitter)} className="grid hover:text-accent duration-200">
    ...
    <div className="card w-60 h-40 bg-neutral text-neutral-content border-2">
      <div className="card-body items-center text-center">
        <button onClick={()=>handleClick(urls.website[0])} className="grid hover:text-accent duration-200">
    ...
    {urls && urls.reddit && 
    <div className="card w-60 h-fit bg-neutral text-neutral-content border-2">
      <div className="card-body items-center text-center">
        <button onClick={()=>handleClick(urls.reddit)} className="grid hover:text-accent duration-200">
    ...
    <div className="card w-60 h-40 bg-neutral text-neutral-content border-2">
      <div className="card-body items-center text-center">
        <button onClick={()=>handleClick(urls.technical_doc)} className="grid hover:text-accent duration-200">
